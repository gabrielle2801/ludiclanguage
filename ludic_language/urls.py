...
from ludic_language.profiles.views import LoginView, IndexSpeechView, IndexPatientView, PatientListView, PatientAddView, PatientDetailView
...
urlpatterns = [
    ...
    path('detail_patient/<int:pk>', PatientDetailView.as_view(), name='detail_patient'),
