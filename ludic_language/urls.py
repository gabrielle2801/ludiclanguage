...
from ludic_language.profiles.views import LoginView, IndexSpeechView, IndexPatientView, PatientListView, PatientView
...
urlpatterns = [
    ...
    path('forms_patient/', PatientView.as_view(), name='form_patient'),
