...
from ludic_language.profiles.views import LoginView, IndexSpeechView, IndexPatientView, PatientListView, PatientCreateView
...
urlpatterns = [
    ...
    path('forms_patient/', PatientCreateView.as_view(), name='form_patient'),
